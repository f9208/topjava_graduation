...
public class VoteTestData {
    ...
    public static Vote VOTE1 = new Vote(VOTE_1_ID, END, ADMIN_ID, BEAR_GRIZZLY_ID);
    public static Vote VOTE2 = new Vote(VOTE_2_ID, START, ADMIN_ID, BEAR_GRIZZLY_ID);
    public static Vote VOTE3 = new Vote(VOTE_3_ID, START, USER_JONNY_ID, BEAR_GRIZZLY_ID);
    public static Vote VOTE4 = new Vote(VOTE_4_ID, START, USER_KET_ID, BEAR_GRIZZLY_ID);
    public static Vote VOTE5 = new Vote(VOTE_5_ID, START, USER_LEO_ID, MEAT_HOME_ID);
    public static Vote VOTE6 = new Vote(VOTE_6_ID, LocalDate.parse("2021-04-26"), ADMIN_ID, MEAT_HOME_ID);
    public static Vote VOTE7 = new Vote(VOTE_7_ID, LocalDate.parse("2021-04-26"), USER_JONNY_ID, MEAT_HOME_ID);
    public static Vote VOTE8 = new Vote(VOTE_8_ID, LocalDate.parse("2021-04-25"), ADMIN_ID, MEAT_HOME_ID);
    public static Vote VOTE9 = new Vote(VOTE_9_ID, LocalDate.parse("2021-04-25"), USER_KET_ID, MEAT_HOME_ID);
    public static Vote VOTE10 = new Vote(VOTE_10_ID, LocalDate.parse("2021-04-24"), ADMIN_ID, BEAR_GRIZZLY_ID);
