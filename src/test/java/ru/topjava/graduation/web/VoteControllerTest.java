...
public class VoteControllerTest extends AbstractRestControllerTest {
    ...
    void getMyVotes() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_PATH)
                ...
                .andExpect(VOTE_TEST_MATCHER.contentJson(List.of(VOTE3, VOTE7, VOTE11, VOTE14_TODAY)));
    }
    ...
    void toVote() throws Exception {
        ...
        VOTE_TEST_MATCHER.assertMatch(created, voteRepository.getVoteByIdAndUserId(created.getId(), SecurityUtil.getAuthUser().getId()));
        ...
        VOTE_TEST_MATCHER.assertMatch(created2, voteRepository.getVoteByIdAndUserId(created.getId(), SecurityUtil.getAuthUser().getId()));
    }
