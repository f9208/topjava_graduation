...
import static ru.f9208.choicerestaurant.repository.testData.RestaurantTestData.bearGrizzly;
import static ru.f9208.choicerestaurant.repository.testData.RestaurantTestData.meatHome;
import static ru.f9208.choicerestaurant.repository.testData.UserTestData.*;
...
public class VoteTestData {
    ...
    public static final int VOTE_16_ID = START_SEQ + 15;
    ...
    public static Vote VOTE14_TODAY_RE_VOTE = new Vote(VOTE_14_ID, LocalDate.now(), USER_JONNY_ID, meatHome);
    public static Vote VOTE15_TODAY = new Vote(VOTE_15_ID, LocalDate.now(), ADMIN_ID, meatHome);
    public static Vote VOTE16_TODAY = new Vote(VOTE_16_ID, LocalDate.now(), USER_KET_ID, meatHome);
